...
const ExamSetupPage: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 600, background: 'rgba(255, 255, 255, 0.95)', borderRadius: 12, boxShadow: '0 4px 20px rgba(0,0,0,0.2)', padding: '2.5rem 2rem', backdropFilter: 'blur(5px)' }}>
        <h2 style={{ color: '#1a1a1a', marginBottom: 24, textAlign: 'center' }}>Examination Setup</h2>
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          <button type="submit" style={{ background: '#4F46E5', color: '#fff', border: 'none', borderRadius: 6, padding: '12px 0', fontWeight: 600, fontSize: 16, cursor: 'pointer', marginTop: 10 }}>Create Session</button>
        </form>
        <div style={{ marginTop: 32 }}>
          <h3 style={{ color: '#374151', marginBottom: 12 }}>Upcoming Sessions</h3>
